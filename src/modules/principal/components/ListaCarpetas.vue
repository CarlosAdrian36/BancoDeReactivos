      ...
      >
        <div class="card-body">
          <div class="flex justify-between">
            <div
              class="size-12 bg-primary-content text-primary rounded-lg flex items-center justify-center"
            >
...
<script setup lang="ts">
  const items = [
    ...
    {
      id: 9,
      titulo: 'Literatura Española del Siglo XX',
      materia: 'Literatura',
      reactivos: 15,
      progreso: 25,
      fecha: 'Hace 7 horas'
    ...
    {
      id: 12,
      titulo: 'Química Inorgánica Avanzada',
      materia: 'Química',
      reactivos: 35,
      progreso: 52,
      fecha: 'Hace 1 día'
    ...
    {
      id: 18,
      titulo: 'Física Mecánica Clásica',
      materia: 'Física',
      reactivos: 48,
      progreso: 76,
      fecha: 'Hace 3 días'
    ...
    {
      id: 20,
      titulo: 'Redacción y Comprensión Lectora',
      materia: 'Lenguaje',
      reactivos: 21,
      progreso: 33,
      fecha: 'Hace 1 día'
