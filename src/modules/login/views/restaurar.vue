...
<template>
  <div class="w-full max-w-md sm:max-w-lg lg:max-w-xl">
    <div
      class="glass-card bg-white/30 dark:bg-white/10 border border-white/30 dark:border-white/10 shadow-2xl rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-300"
    >
      <!-- HEADER -->
      <div class="flex flex-col items-center gap-6 mb-10">
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-base-content/50">Restaurar Contraseña</p>
        </div>
      </div>
      ...
      <form @submit.prevent="onSubmit" class="space-y-6">
        <!-- Usuario -->
        <div>
          <label class="block text-sm font-medium text-base-content/30 mb-2">
            Nueva Contraseña
          </label>
          ...
          <div class="mt-3 space-y-1 text-sm">
            <div
              ...
              :class="values.contrasena?.length >= 8 ? 'text-green-500' : 'text-gray-400'"
            >
